...
namespace QuanLyThuVienDB
{
    ...
    {
        string Conn = "Data Source=NGUYENMANHTAI\\MSSQLSERVER01;Initial Catalog=QuanLyThuVienDB;Integrated Security=True";
        ...
        public FormQuanLyNhanVien(string Message) : this()
        {
            _message = Message;
        ...
        private void TrangChu_Load(object sender, EventArgs e)
        {
            ...
            thongke();
            tracuusach();
            guna2TabControl1.SelectedTab = guna2TabControl1.TabPages[4];
        }
